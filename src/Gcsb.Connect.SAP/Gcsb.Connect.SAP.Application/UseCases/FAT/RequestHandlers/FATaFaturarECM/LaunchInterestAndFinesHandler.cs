    ...
    public class LaunchInterestAndFinesHandler : Handler
    {
        public override void ProcessRequest(FATRequest request)
        {
            ...
            stores.ForEach(store =>
            {
                ...
                lines.AddRange(GetLines(interestServices, interestAccountingEntries, request.Cycle.AddMonths(1), storeType));
                lines.AddRange(GetLines(finesServices, finesAccountingEntries, request.Cycle.AddMonths(1), storeType));
