...
namespace Gcsb.Connect.SAP.Application.UseCases.FAT.Strategy.Deferral.Provision
{
    ///<summary>
    ///US 58602
    ///Cenário 8: Diferimento provisionado INICIAL com número de parcelas MAIOR que 12, a mais de 30 dias da data da compra
    ///</summary>
    public class LongTermInitialDeferralProvisionNotNFEmittedGreaterThan30PurchaseDays : DeferralAccountingEntry, IDeferralStrategy
    {
            ...
            if (offers.Any())
            {
                if (ValidateFinancialAccount(offers,deferralFinancialAccounts,accountingAccounts, interfaceType))
                {
                    offers.ForEach(offer =>
                    {
                        ...
                        offer.SetDeferralType(DeferralType.LongTermInitialDeferralProvisionNotNFEmittedGreaterThan30PurchaseDays);
