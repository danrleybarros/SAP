...
namespace Gcsb.Connect.SAP.Application.UseCases.FAT.Strategy.Deferral.Provision
{
    ///<summary>
    ///US 58602
    ///Cenário 1: Diferimento provisionado INICIAL com número de parcelas MENOR OU IGUAL a 12, a menos de 30 dias da data da compra
    ///</summary>
    public class ShortTermInitialDeferralProvisionNotNFEmittedLessThan30PurchaseDays : DeferralAccountingEntry, IDeferralStrategy
    {
            ...
            if (offers.Any())
            {
                if (ValidateFinancialAccount(offers, deferralFinancialAccounts, accountingAccounts, interfaceType))
                {
                    offers.ForEach(offer =>
                    {
                        ...
                        offer.SetDeferralType(DeferralType.ShortTermInitialDeferralProvisionNotNFEmittedLessThan30PurchaseDays);
