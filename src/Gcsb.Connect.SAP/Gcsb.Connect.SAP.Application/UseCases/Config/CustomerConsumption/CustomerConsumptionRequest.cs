...
{
    public class CustomerConsumptionRequest
    {
        ...
        public List<ConsumptionOutput> Consumptions { get; set; }
        public List<PaymentCreditCard> PaymentsCredit { get; set; }
        public List<PaymentBoleto> PaymentsBoleto { get; set; }

        public CustomerConsumptionRequest(DocumentType documentType, string document)
        {
            ...
            this.Consumptions = new List<ConsumptionOutput>();
