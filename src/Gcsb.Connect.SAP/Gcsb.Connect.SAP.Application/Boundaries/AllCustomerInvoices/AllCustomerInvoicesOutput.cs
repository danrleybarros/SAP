...
namespace Gcsb.Connect.SAP.Application.Boundaries.AllCustomerInvoices
{
    public class AllCustomerInvoicesOutput
    {
        ...
        public AllCustomerInvoicesOutput(long customerCode, string companyName, string cycleCode, string invoiceNumber, DateTime invoiceDate, decimal invoiceValue, List<Services> services,
            string paymentStatus, DateTime? paymentDate)
        {
