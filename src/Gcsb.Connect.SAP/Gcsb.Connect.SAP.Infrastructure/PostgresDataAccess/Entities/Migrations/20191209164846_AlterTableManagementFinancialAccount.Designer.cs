...
namespace Gcsb.Connect.SAP.Infrastructure.PostgresDataAccess.Entities.Migrations
{
    ...
    [Migration("20191209164846_AlterTableManagementFinancialAccount")]
    partial class AlterTableManagementFinancialAccount
    {
                    ...
                    b.OwnsOne("Gcsb.Connect.SAP.Infrastructure.PostgresDataAccess.Entities.ManagementFinancialAccount.ARR", "ARR", b1 =>
                        {
                            ...
                            b1.OwnsOne("Gcsb.Connect.SAP.Infrastructure.PostgresDataAccess.Entities.ManagementFinancialAccount.Billet", "Billet", b2 =>
                                {
                                    b2.Property<Guid>("ARRManagementFinancialAccountId");

                                    b2.Property<string>("FinancialAccount")
                                        .IsRequired()
                                        .HasColumnName("FinancialAccountBillet")
                                    ...
                                    b2.HasOne("Gcsb.Connect.SAP.Infrastructure.PostgresDataAccess.Entities.ManagementFinancialAccount.ARR")
                                        .WithOne("Billet")
                                        .HasForeignKey("Gcsb.Connect.SAP.Infrastructure.PostgresDataAccess.Entities.ManagementFinancialAccount.Billet", "ARRManagementFinancialAccountId")
                                        .OnDelete(DeleteBehavior.Cascade);
                                    ...
                                    b2.OwnsOne("Gcsb.Connect.SAP.Infrastructure.PostgresDataAccess.Entities.ManagementFinancialAccount.AccountingAccount", "AccountingAccount", b3 =>
                                        {
                                            b3.Property<Guid>("BilletARRManagementFinancialAccountId");

                                            b3.Property<string>("Credit")
                                                .IsRequired()
                                                .HasColumnName("AccountingAccountBilletCredit")
                                                .HasColumnType("varchar(15)");

                                            b3.Property<string>("Debit")
                                                .IsRequired()
                                                .HasColumnName("AccountingAccountBilletDebit")
                                                .HasColumnType("varchar(15)");

                                            b3.HasKey("BilletARRManagementFinancialAccountId");

                                            b3.ToTable("ManagementFinancialAccount","JsdnBill");

                                            b3.HasOne("Gcsb.Connect.SAP.Infrastructure.PostgresDataAccess.Entities.ManagementFinancialAccount.Billet")
                                                .WithOne("AccountingAccount")
                                                .HasForeignKey("Gcsb.Connect.SAP.Infrastructure.PostgresDataAccess.Entities.ManagementFinancialAccount.AccountingAccount", "BilletARRManagementFinancialAccountId")
                                                .OnDelete(DeleteBehavior.Cascade);
                                        });
                                });
