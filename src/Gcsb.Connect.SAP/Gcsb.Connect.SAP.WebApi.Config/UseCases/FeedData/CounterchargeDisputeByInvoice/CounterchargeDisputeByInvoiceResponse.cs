...
{
    public class CounterchargeDisputeByInvoiceResponse
    {
        ...
        public CounterchargeDisputeByInvoiceResponse(string tipoSubscricao, DateTime? dataMovimentacao,
            string aReceber, string tipoTransacao, string uF, string ciclo, DateTime? referenciaCicloFaturamento,
            string codigoEmpresa, string flagTipoFaturamento, decimal valorTransacao, string numeroFatura,
            int customerCode, string codigoFranquia, string cNPJ, string cPF, string nomedaEmpresadoCliente,
            DateTime dataVencimento, DateTime dataCriacaoFatura, DateTime dataIniciodoCiclo, decimal? saldoTotalGeral,
            DateTime dataFimCiclo, DateTime? dataCriacaoPedido, char statusContadoCliente, char inadimplenciaPremeditada,
            string produto, string statusPagamento, string tipoDisputa, DateTime? dataConcessaoCredito, int numeroPedido,
