...
namespace Gcsb.Connect.SAP.WebApi.Config.UseCases.FeedData.CustomerConsumption
{
    public class CustomerResponse
    {
        ...
        public CustomerResponse(long customerCode, string companyName, string cycleCode, string invoiceNumber, DateTime invoiceDate, decimal invoiceValue,
            List<Services> services, string paymentStatus, DateTime? paymentDate, string storeAcronym)
        {
