...
namespace Gcsb.Connect.SAP.Tests.Builders.FAT.FAT58
{
    public class LaunchBuilder
    {
        ...
        public LaunchBuilder WithStoreAcronym(StoreType storeType)
        {
            SType = storeType;
            return this;
        }
        ...
        public LaunchECM Build()
            => new LaunchECM(NumberLine, LaunchDate, FinancialAccount, Complement, LaunchValue, ISSCode, ISSValue, Product, InternalOrder, UF, CostObject, BillingCycle, TaxCostCenter, NetValue, PaymentMethod, AccountingEntry, AccountingAccount, SType, IsDiscount);
    }
}
