...
namespace Gcsb.Connect.SAP.Tests.Builders.FAT.FAT55
{
    public class LaunchBuilder
    {
        ...
        public LaunchFaturado Build()
        {
            return new LaunchFaturado(NumberLine, LaunchDate, FinancialAccount, Complement, LaunchValue, ISSCode, ISSValue, Product, InternalOrder, UF, CostObject, BillingCycle, TaxCostCenter, NetValue, PaymentMethod, AccountingEntry, AccountingAccount, SType, IsDiscount);
        }
    }
}
