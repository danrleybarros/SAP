...
namespace Gcsb.Connect.SAP.Tests.Cases.Application.FATaFaturarECM
{
    [TestCaseOrderer("Gcsb.Connect.SAP.Tests.TestCaseOrdering.PriorityOrderer", "Gcsb.Connect.SAP.Tests")]
    [Collection("H")]
    public class FATaFaturarECMUseCaseTest : IClassFixture<Fixture.ApplicationFixture>
    {
        ...
        public readonly IFileGenerator<SAP.Domain.FAT.FATaFaturarECM.FATaFaturarECM> fileGenerator;
        ...
        public readonly IFATUseCase<SAP.Domain.FAT.FATaFaturarECM.FATaFaturarECM> fatUseCase;
        ...
        public FATaFaturarECMUseCaseTest(Fixture.ApplicationFixture fixture)
        {
            ...
            this.fileGenerator = fixture.Container.Resolve<IFileGenerator<SAP.Domain.FAT.FATaFaturarECM.FATaFaturarECM>>();
            ...
            this.fatUseCase = fixture.Container.Resolve<IFATUseCase<SAP.Domain.FAT.FATaFaturarECM.FATaFaturarECM>>();
        ...
        {
            var dir = Path.GetDirectoryName(typeof(FATaFaturarECMUseCaseTest).Assembly.Location);
        ...
        public void ShouldCreateFatUseCaseMonthPrevious()
        {
            ...
            var resquest = new FATRequest(TypeRegister.FATAFATURARECM, idFileBill_Faturado, DateTime.UtcNow.AddMonths(-1));
        ...
        {
            var resquest = new FATRequest(TypeRegister.FATAFATURARECM, idFileBill, DateTime.UtcNow);
            var fat = fatUseCase.Execute(resquest);
            Assert.NotNull(resquest.Logs);
        }
