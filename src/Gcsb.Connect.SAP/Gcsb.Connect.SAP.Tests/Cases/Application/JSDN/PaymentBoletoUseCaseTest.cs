...
namespace Gcsb.Connect.SAP.Tests.Cases.Application.JSDN
{
    ...
    [Collection("I")]
    public class PaymentBoletoUseCaseTest : IClassFixture<Fixture.ApplicationFixture>
    {
        private readonly IPaymentFeedUseCase<PaymentBoleto> paymentFeedUC;
        ...
        public PaymentBoletoUseCaseTest(Fixture.ApplicationFixture fixture)
        {
            this.paymentFeedUC = fixture.Container.Resolve<IPaymentFeedUseCase<PaymentBoleto>>();
        ...
        public void PaymentFeedShouldExecute(string relativePath)
        {
            ...
            var request = new DocFeedRequest(TypeRegister.PAYMENTBOLETO, "Sample_PaymentBoleto_7-03-2020.tsv", base64);

            Assert.True(paymentFeedUC.Execute(request) > 0);
            Assert.True(request.DocFeed.FirstOrDefault().IdFile != defaultGuid);
        }
        ...
        {
            DocFeedRequest request = new DocFeedRequest(TypeRegister.PAYMENTBOLETO, "Sample_PaymentBoleto", "E4OjQzLjAwMCBBbWVyaWNhL1Nhb19QYXVsbwkxNTgwNjk3CQk5LDAxCQkJCQkJCQkJCQkJCQkJCQkJCQkNCg");
            Assert.True(paymentFeedUC.Execute(request) == 0);
        }
